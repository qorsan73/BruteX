...
\033[1;91m<═══\033[1;41m\033[1;97m Created by qorsan taiz \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by qorsan taiz
\033[1;92m""")
...
# main script start
os.system("xdg-open https://youtube.com/@hacking-world")
time.sleep(5)
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://instagram.com/mostafa.qt73")
            
			elif fol == '2' or fol == '02':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my Facebook page in your device \n")
				time.sleep(1)
				os.system("xdg-open https://www.facebook.com/profile.php?id=100078426657327&mibextid=ZbWKwL")

			elif fol == '3' or fol == '03':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my Github profile in your device \n")
				time.sleep(1)
				os.system("xdg-open https://github.com/qorsan73")
				...
				time.sleep(1)
				os.system("xdg-open https://t.me/qorsantaez73")
